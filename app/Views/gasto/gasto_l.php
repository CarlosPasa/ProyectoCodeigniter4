...
<div class="row mb-2">
  ...
  <div class="col-sm-4">
    <h3 class=""><?php echo "Gastos del mes: S/.".round($gasto_mes,2); ?></h3>
  </div>
  <div class="col-sm-3">
    <h3 class=""><?php echo "Saldo : S/.".round((2750-$gasto_mes),2); ?></h3>
  </div>
</div>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <?php 
                if (hasPermissions('gasto_add'))
                  vButtonDefault("btnGastoNuevo", "Nuevo", "", "fa fa-plus", "btn btn-primary", "onGasto_nuevo()","", false);
              ?>
