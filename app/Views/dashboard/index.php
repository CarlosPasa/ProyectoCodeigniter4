<?= $this->extend('include/dashboard_template') ?>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo "S/. ".round($gasto_mes,2) ?></h3>
                <p>Gastos del mes</p>
              </div>
              <div class="icon">
                <i class="ion ion-cash"></i>
              </div>
              <a href="gasto" class="small-box-footer">Más información <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $nro_movimientos_mes ?></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php echo "S/. ".$gastos_anuales ?></h3>
                <p>Gasto del año</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="gasto/oneMonth/0" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
...
<script>
  // Variable PHP
  var gasto_mes = <?php echo $gasto_mes ?>;
  var array_mes_gastos = <?php echo $array_mes_gastos ?>;
  var gastos_anuales = <?php echo $gastos_anuales ?>;
  var array_ahorro_gastos = <?php echo $array_ahorro_gastos ?>;
  var ahorros_monto = <?php echo $ahorros_monto ?>;
  var ahorros_descripcion = <?php echo $ahorros_descripcion ?>;
  var ahorros_color = <?php echo $ahorros_color ?>;
</script>
